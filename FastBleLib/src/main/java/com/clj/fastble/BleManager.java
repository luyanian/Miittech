...
public class BleManager {
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (bleDevice == null || bleDevice.getDevice() == null) {
            bleGattCallback.onConnectFail(bleDevice,new NotFoundDeviceException());
        } else {
    ...
    public void write(BleDevice bleDevice,
        ...
        if (data == null) {
            ...
            callback.onWriteFailure(bleDevice,new OtherException("data is Null !"));
            return;
        }
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onWriteFailure(bleDevice,new OtherException("This device not connect!"));
        } else {
            bleBluetooth.newBleConnector()
    ...
    public void readRssi(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onRssiFailure(bleDevice,new OtherException("This device not connect!"));
        } else {
    ...
    public boolean isConnected(String mac) {
        List<BleDevice> bleDevices = getAllConnectedDevice();
