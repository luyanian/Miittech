...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        mapapi.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private mapapi.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        mapapi.clusterutil.ui.SquareTextView squareTextView =
                new mapapi.clusterutil.ui.SquareTextView(context);
