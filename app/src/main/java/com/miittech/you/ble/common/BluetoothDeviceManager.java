package com.miittech.you.ble.common;

import android.content.Context;
import android.os.Handler;
import android.os.Looper;

import com.miittech.you.ble.event.CallbackDataEvent;
import com.miittech.you.ble.event.ConnectEvent;
import com.miittech.you.ble.event.NotifyDataEvent;
import com.miittech.you.ble.event.ScanEvent;
...
public class BluetoothDeviceManager {
    ...
    private IBleCallback bleCallback = new IBleCallback() {
        ...
        public void onSuccess(final byte[] data, BluetoothGattChannel bluetoothGattInfo, BluetoothLeDevice bluetoothLeDevice) {
            ...
            if (bluetoothGattInfo != null && (bluetoothGattInfo.getPropertyType() == PropertyType.PROPERTY_INDICATE
                ...
                DeviceMirror deviceMirror = mDeviceMirrorPool.getDeviceMirror(bluetoothLeDevice.getAddress());
    ...
    public boolean isConnected(String macAddress) {
        return ViseBle.getInstance().isConnect(macAddress);
    }
    ...
    public void write(final String devMac, byte[] data) {
    ...
    public void read(String devMac) {
        DeviceMirror deviceMirror = mDeviceMirrorPool.getDeviceMirror(devMac);
        if (deviceMirror != null) {
            deviceMirror.readData();
        }
    }

    public void registerNotify(String devMac, boolean isIndicate) {
        DeviceMirror deviceMirror = mDeviceMirrorPool.getDeviceMirror(devMac);
        if (deviceMirror != null) {
    ...
    private void send(final String devMac){
