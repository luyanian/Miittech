 ...
 */
public class BtnTextView extends TextView {
    ...
    public BtnTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BtnTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 读取属性值
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.BtnTextView);
        strokeWidth = ta.getDimensionPixelSize(R.styleable.BtnTextView_strokeWidth, strokeWidth);
        cornerRadius = ta.getDimensionPixelSize(R.styleable.BtnTextView_cornerRadius, cornerRadius);
        strokeColor = ta.getColor(R.styleable.BtnTextView_strokeColor, Color.TRANSPARENT);
        mFollowTextColor = ta.getBoolean(R.styleable.BtnTextView_followTextColor, true);
        ta.recycle();
